    ...
    <footer className="bg-white shadow-md py-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          >
            ...
            <span className="hover:underline">info@msecurities.mn</span>
          </Link>

          {/* Phone Link */}
          <Link 
            href="tel:+9769982-0776"
            className="flex items-center space-x-2 text-gray-600 hover:text-teal-500 transition-colors group"
          >
            <svg 
              className="w-5 h-5 group-hover:text-teal-500 transition-colors" 
            ...
            <span className="hover:underline">+976 9982-0776</span>
          </Link>
          ...
          >
            ...
            <span className="hover:underline">Find us on Google Maps</span>
          </Link>
        </div>
      </div>
      ...
      <div className="mt-8 pt-8 border-t border-gray-200">
        <p className="text-center text-gray-600 text-sm">
          &copy; {new Date().getFullYear()} M Securities. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
