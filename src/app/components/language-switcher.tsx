    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex items-center">
          ...
          <svg 
            className="w-4 h-4 ml-1 text-gray-400 group-hover:text-teal-500 transition-colors duration-300" 
            fill="none" 
            viewBox="0 0 24 24" 
            stroke="currentColor"
          >
      ...
      <div className={`absolute right-0 mt-2 py-2 w-40 bg-white rounded-lg shadow-lg border border-gray-100 
                    ...
                    ${isEnglish ? 'opacity-0 scale-95 invisible' : 'opacity-100 scale-100 visible'}`}>
        <button
          onClick={toggleLanguage}
